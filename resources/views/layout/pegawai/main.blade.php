...
<html lang="en">
  <head>
	...
	<link href="https://unpkg.com/@tabler/icons@1.68.0/iconfont/tabler-icons.min.css" rel="stylesheet">
  ...
  <body >
      ...
      <header class="navbar-expand-md">
        <div class="collapse navbar-collapse" id="navbar-menu">
          <div class="navbar">
			...
			@elseif ($role == 2)
				@include('layout.kapro.sidebar')
			@elseif ($role == 3)
				@include('layout.manajerhc.sidebar')
			@elseif ($role == 4)
				@include('layout.pusat.sidebar')
			@endif
    ...
    <script src="{{asset('vendor')}}/dist/libs/jsvectormap/dist/maps/world.js?1692870487" defer></script>
    <script src="{{asset('vendor')}}/dist/libs/jsvectormap/dist/maps/world-merc.js?1692870487" defer></script>
    <!-- Tabler Core -->
