<div class="container-xl">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="nav-link" href="{{asset('vendor')}}/" >
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
          <div class="dropdown-menu-columns">
            <div class="dropdown-menu-column">
              <a class="dropdown-item" href="{{asset('vendor')}}/empty.html">
                Empty page
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/cookie-banner.html">
                Cookie banner
                <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/chat.html">
                Chat
                <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/activity.html">
                Activity
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/gallery.html">
                Gallery
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/invoice.html">
                Invoice
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/search-results.html">
                Search results
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/pricing.html">
                Pricing cards
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/pricing-table.html">
                Pricing table
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/faq.html">
                FAQ
                <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/users.html">
                Users
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/license.html">
                License
              </a>
            </div>
            <div class="dropdown-menu-column">
              <a class="dropdown-item" href="{{asset('vendor')}}/logs.html">
                Logs
                <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/music.html">
                Music
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/photogrid.html">
                Photogrid
                <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/tasks.html">
                Tasks
                <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/uptime.html">
                Uptime monitor
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/widgets.html">
                Widgets
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/wizard.html">
                Wizard
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/settings.html">
                Settings
                <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/trial-ended.html">
                Trial ended
                <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/job-listing.html">
                Job listing
                <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/page-loader.html">
                Page loader
                <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
              </a>
            </div>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
          <div class="dropdown-menu-columns">
            <div class="dropdown-menu-column">
              <a class="dropdown-item" href="{{asset('vendor')}}/layout-horizontal.html">
                Horizontal
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/layout-boxed.html">
                Boxed
                <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/layout-vertical.html">
                Vertical
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/layout-vertical-transparent.html">
                Vertical transparent
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/layout-vertical-right.html">
                Right vertical
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/layout-condensed.html">
                Condensed
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/layout-combo.html">
                Combined
              </a>
            </div>
            <div class="dropdown-menu-column">
              <a class="dropdown-item" href="{{asset('vendor')}}/layout-navbar-dark.html">
                Navbar dark
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/layout-navbar-sticky.html">
                Navbar sticky
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/layout-navbar-overlap.html">
                Navbar overlap
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/layout-rtl.html">
                RTL mode
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/layout-fluid.html">
                Fluid
              </a>
              <a class="dropdown-item" href="{{asset('vendor')}}/layout-fluid-vertical.html">
                Fluid vertical
              </a>
            </div>
          </div>
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{asset('vendor')}}/icons.html" >
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{asset('vendor')}}/emails.html" >
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
          ...
          <a class="dropdown-item" href="{{asset('vendor')}}/changelog.html">
            Changelog
          </a>
