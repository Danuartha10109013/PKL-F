  ...
  <div class="container-xl">
    <div class="row g-2 align-items-center">
      ...
      <div class="col-auto ms-auto d-print-none">
          ...
          <a href="{{route('hc.kelola-user.add')}}" class="btn btn-primary d-none d-sm-inline-block" data-bs-toggle="modal" data-bs-target="#modal-report">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="d-flex justify-content-center">
              ...
              <div class="perpaginationan" style=" padding: 15px 0;">
                  {{ $data->links() }}
              </div>
            </div>
          </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                ...
                <div class="h1 mb-3 mt-2">{{$count}}</div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                ...
                <div class="h1 mb-3 mt-2">{{$countpegawai}}</div>
                <div class="d-flex mb-1">
                  <div>Conversion rate</div>
                  <div class="ms-auto">
                  </div>
        ...
        <div class="row mt-3">
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <div class="subheader">Kepala Project</div>   
                </div>
                <div class="h1 mb-3 mt-2">{{$countkapro}}</div>
                <div class="d-flex mb-1">
                  <div>Conversion rate</div>
                  <div class="ms-auto">
                  </div>
